...
import { PeriodicElement, ViewprescriptionComponent } from '../viewprescription/viewprescription.component';
...
export class ViewpetienthistoryComponent implements AfterViewInit {
  ...
  //   for (let test of this.arr) {
  //     console.log('tests', Number(test));
  //     this.Service.getAllTests(Number(test)).subscribe(
  //       (response: TestList[]) => {
  //         this.tests = response;
  //         sessionStorage.setItem('visitid', test);
